...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: "2021",
    description:
      "1, 2, 3 comme le nombre d’interventions réalisées afin d’aménager cet appartement construit dans les années 60, à partir d’un seul et même matériau. Grâce au valchromat, panneau de fibre bois teinté dans la masse, les différentes pièces de mobilier viennent colorer les espaces de vie. L’effort principal est porté sur la cuisine qui se veut épurée et simple d’utilisation. Partant d’un plan très biscornu, à cause de nombreuses gaines, le but était d’en faire un espace de cuisine fonctionnel, adapté à la modernité. Pas de porte, pas de meuble haut, les étagères se suivent et offrent de grands plans de travail et des rangements en quantité. Rien n’est caché, la convivialité s’exprime aussi par le fait que tout le monde peut s’approprier la cuisine et son fonctionnement d’un seul regard.",
    coverImage: project1,
    images: [project1],
    plans: [],
    type: "Mission complète",
